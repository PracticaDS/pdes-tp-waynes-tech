...
export const initialState = {
    botones: [
        {image:boton_start,       press:"unselected", id:1, action:"put"},
        {image:boton_seller,      press:"unselected", id:2, action:"put"},
        {image:boton_crafter,     press:"unselected", id:3, action:"put"},
        {image:boton_furnace,     press:"unselected", id:4, action:"put"},
        {image:boton_transporter, press:"unselected", id:5, action:"put"},
        {image:boton_borrar,      press:"unselected", id:6, action:"delete"},
        {image:boton_rotar,       press:"unselected", id:7, action:"rotate"},
        {image:boton_move,        press:"unselected", id:8, action:"move"}
    ],
    configFabrica: {
       numeroFilas: 10,
       numeroColumnas: 8
